...
const es = {
  ...
  benchmarkLive: {
    ...
    // HISTORICAL BENCHMARKS ARCHITECTURE: a collapsed-by-default
    // "Histórico" section below the current result, lazily loaded only
    // when opened (§11). Never implies a trend from too few real
    // periods (see trendEligibility reuse), never interpolates a gap.
    historicalTitle: "Histórico",
    historicalSubtitle: "Cómo cambió este benchmark en los últimos {n} trimestres.",
    historicalLoading: "Calculando histórico…",
    historicalError: "No pudimos calcular el histórico.",
    historicalNotEnoughPeriods: "Todavía no hay suficientes períodos con datos para mostrar una tendencia.",
    historicalChartSrHint: "Ver el detalle de cada período en la lista debajo del gráfico.",
    historicalInsufficientDetail: "Muestra insuficiente en este período (cohorte n={n}).",
    historicalNoDataDetail: "Sin datos para este período.",
    historicalMethodologyBlockDetail: "Alcance requiere Rango de Inversión y Duración — no disponible por período.",
    historicalErrorDetail: "No se pudo calcular este período.",
    historicalDeltaUp: "La mediana aumentó {percent}% respecto del período anterior.",
    historicalDeltaDown: "La mediana disminuyó {percent}% respecto del período anterior.",
...
const en: typeof es = {
  ...
  benchmarkLive: {
    ...
    // HISTORICAL BENCHMARKS ARCHITECTURE: see the ES block's comment.
    historicalTitle: "Historical",
    historicalSubtitle: "How this benchmark has changed over the last {n} quarters.",
    historicalLoading: "Calculating historical data…",
    historicalError: "We couldn't calculate the historical view.",
    historicalNotEnoughPeriods: "There aren't enough periods with data yet to show a trend.",
    historicalChartSrHint: "See each period's detail in the list below the chart.",
    historicalInsufficientDetail: "Insufficient sample for this period (cohort n={n}).",
    historicalNoDataDetail: "No data for this period.",
    historicalMethodologyBlockDetail: "Reach requires Spend Range and Duration — not available per period.",
    historicalErrorDetail: "This period couldn't be calculated.",
    historicalDeltaUp: "The median increased {percent}% versus the previous period.",
    historicalDeltaDown: "The median decreased {percent}% versus the previous period.",
